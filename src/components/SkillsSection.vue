...
const skillCategories = [
  {
    ...
    skills: ['Vue.js', 'React', 'TypeScript', 'Tailwind CSS', 'HTML/CSS', 'JavaScript'],
  },
  {
    title: 'Backend',
...
<template>
  <section id="skills" class="py-24 sm:py-32 bg-muted/30">
          ...
          <div class="p-6 rounded-xl border border-border bg-card/50 backdrop-blur-sm hover:bg-card hover:border-border/80 transition-all duration-300 h-full">
            ...
            <div class="flex flex-wrap gap-2">
              <Badge
                ...
                :key="skill"
                variant="secondary"
                class="font-normal text-xs hover:bg-secondary/80 transition-colors"
              >
                {{ skill }}
              </Badge>
            </div>
